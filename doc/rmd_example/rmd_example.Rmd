...
```{r horse-pops-plot, echo = FALSE, out.width = '90%', fig.cap = 'Horse populations for all provinces in Canada from 1906-1972', fig.align = 'center'}
...
knitr::kable(horses_sd_table, align = "cc", caption = "Sample standard deviations of horse populations for each province in Canada between 1906 and 1972.")
```
...
```{r horse-pop-plot-largest-sd, echo=FALSE, out.width='60%', fig.align='center', fig.cap= "Horse populations for the province with the largest standard deviation."}
