...
knitr::kable(horses_sd_table, caption = "Sample standard deviations of horse populations for each province in Canada between 1906 and 1972.")
```
...
```{r horse-pop-plot-largest-sd, echo=FALSE, out.width='50%', fig.align='center', fig.cap= "Horse populations for the province with the largest standard deviation."}
